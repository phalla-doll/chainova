...
export default function Page() {
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans text-gray-900">
      {/* Header */}
      <div className="flex flex-col md:flex-row border-b border-gray-300 shrink-0">
      ...
      <div className="flex flex-col lg:flex-row flex-grow">
        ...
        <div className="w-full lg:w-1/2 border-r border-gray-300 flex flex-col">
          ...
          <div className="flex-grow p-8 md:p-12 lg:p-16 border-b border-gray-300 flex flex-col justify-center">
            ...
            <h2 className="text-4xl md:text-[3.5rem] lg:text-[4rem] xl:text-[5rem] font-semibold leading-[1.05] tracking-tight mb-6 uppercase">
